...
class FacebookAuth extends Component {
    ...
    // } 
    render() {       
        let controlButton = this.state.user && this.state.authenticated ? <button className="button" onClick={ logout }>Logout</button>
          : <button className="button" onClick={ () => login(this) }>Login With Facebook Authentication</button>
